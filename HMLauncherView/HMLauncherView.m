...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer {
    ...
    if ([gestureRecognizer isKindOfClass:[UILongPressGestureRecognizer class]] && self.dragIcon != nil && self.editing) {
        ...
        return NO;
    } else if ([gestureRecognizer isKindOfClass:[UILongPressGestureRecognizer class]] && self.editing == NO && [gestureRecognizer isEqual:icon.draggingGestureRecogniser] == NO) {
